...
| [change-integrity-loop](docs/plans/change-integrity-loop/README.md) | In progress (`T05`) | Context-independent contract guard, atomic patch preflight, dual-depth remediation, and structural convergence |
