...
| [enforcement-truth-at-speed](docs/plans/enforcement-truth-at-speed/README.md) | Planned (Phase Z) | Restore packed-artifact truth and one adapter verdict, then earn 10× feedback and causal field proof |
