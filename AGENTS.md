...
| [change-integrity-loop](docs/plans/change-integrity-loop/README.md) | Complete (unreleased) | Context-independent contract guard, atomic patch preflight, dual-depth remediation, and structural convergence |
