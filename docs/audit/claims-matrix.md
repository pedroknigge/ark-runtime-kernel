...
| C-020 | Current release identity is aligned at 3.9.0 | [Release notes](../releases/3.9.0.md) | package/lock/version/server metadata | OK | release gate owns future sync |
...
| C-028 | V03/V05/B01 evidence measures time to the real merge gate, observed false blocks/bypasses, and independent review | [Roadmap evidence](../../ROADMAP.md#success-metrics) · [Field kit](../field/README.md) | Z08 immutable 144-cell causal ledger/report · measured classifications · historical beta declaration check · field templates (not filled) | Partial | Z07/Z08/Z10 claim evidence earned in 3.8.0; residual `Z09`/`RB-11` still owns retained adoption and verified reviewer identity only — field kit is scaffolding, not close |
