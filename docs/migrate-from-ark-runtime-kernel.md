...
**arkgate@3.9.0** (current stable) installs a physically distinct exact TypeScript 6 analysis host
...
`3.9.0` is the current stable version when this guide was updated; prefer `arkgate@latest` for a
